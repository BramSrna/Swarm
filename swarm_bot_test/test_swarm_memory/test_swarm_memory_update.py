...
class TestSwarmMemoryUpdate(NetworkNodeTestClass):
    def test_can_write_to_swarm_memory_objects_when_info_stored_on_local_swarm_bot(self):
        ...
        test_swarm_bot_1.write_to_swarm_memory(test_mem_id, new_val)

        self.assertEqual(new_val, test_swarm_bot_1.read_from_swarm_memory(test_mem_id))

    def test_can_write_to_swarm_memory_objects_when_info_stored_on_directly_connected_swarm_bot(self):
        test_swarm_bot_1 = self.create_network_node(SwarmBot)
        ...
        test_swarm_bot_2.write_to_swarm_memory(test_mem_id, new_val)

        self.wait_for_idle_network()
        self.assertEqual(new_val, test_swarm_bot_2.read_from_swarm_memory(test_mem_id))
        self.assertEqual(new_val, test_swarm_bot_1.read_from_swarm_memory(test_mem_id))

    def test_can_write_to_swarm_memory_objects_when_info_stored_on_non_directly_connected_swarm_bot(self):
        test_swarm_bot_1 = self.create_network_node(SwarmBot)
        test_swarm_bot_2 = self.create_network_node(SwarmBot)
        ...
        test_swarm_bot_3.write_to_swarm_memory(test_mem_id, new_val)
