...
class TestSwarmBotMessaging(NetworkNodeTestClass):
    ...
    def test_error_raised_when_synchronous_message_does_not_receive_a_response_within_the_expected_time_limit_for_directly_connected_bots(self):
        test_swarm_bot_1 = self.create_network_node(SwarmBot)
        test_swarm_bot_2 = self.create_network_node(SwarmBot)
    ...
    def test_error_raised_when_synchronous_message_does_not_receive_a_response_within_the_expected_time_limit_for_non_directly_connected_bots(self):
        test_swarm_bot_1 = self.create_network_node(SwarmBot)
        test_swarm_bot_2 = self.create_network_node(SwarmBot)
        test_swarm_bot_3 = self.create_network_node(SwarmBot)
